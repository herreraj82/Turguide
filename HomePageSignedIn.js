var HomePageSignedIn = function(headerObj, sharedPrepsObj, controllerObj) {
	...
	this.whenStarButtonClickedArtist = function(starButton, mpaDiv) {
		...
		this.removeFaveAJAXCall(starButton.data('artid'), starButton, mpaDiv);
	...
	this.createArtistAJAXDiv = function(jsonResult) {
		...
		var starButton = $('<button class="starButton" data-artid="'+jsonResult.artid+'" data-favorited="'+favoriteBool+'">&#9733;</button>');
		mpaDiv.append(starButton);
		starButton.addClass('favorite');
		starButton.click(function(){
			currentObj.whenStarButtonClickedArtist(starButton, mpaDiv)
		});
	...
	this.removeFaveAJAXCall = function(artid, starButton, mpaDiv) {
		var currentObj = this;
		var url_base = "https://wwwp.cs.unc.edu/Courses/comp426-f17/users/gibsonb/finalproj";
